...
def get_params():
    params = {
        'config': 'configs/yaml/deim_dfine_hgnetv2_n_mg.yml',
        'weight': 'outputs/NEU-DET_IECA_CAA-LPConv-DySample/best_stg2.pth',
        'device': 'cuda:0',
        ...
        'layer': ['model.backbone[4]', 'model.encoder[8]'],
